...
(function (Raphael) {
    ...
    var doc = document, win = window,
        ColorPicker = function (x, y, size, initcolor, element) {
            ...
            var w3 = 3 * size / 200,
                ...
                height = size + size20 * 2 + padding * 3,
								...
								// t: ColorPicker "object"
                t = this,

                H = 1, S = 1, B = 1, s = size - (size20 * 4),

								// get Raphael object as "r"
            ...
            w3 < 1 && (w3 = 1);
						...
						// init color picker icon (main circle)
            r.colorPickerIcon(size2, size2, size2 - padding);

						// circular cursor for selecting color on icon (main circle)
		...
		code_descr : "rect black .5 opacity stroke w3",
                stroke: "#000",
                opacity: .5,
                "stroke-width": w3
            }));
            t.cursorb.push(t.cursorb[0].clone().attr({
		code_descr : "rect white 1 opacity stroke w1",
                stroke: "#fff",
                opacity: 1,
                "stroke-width": w1
            }));
